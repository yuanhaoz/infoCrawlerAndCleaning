...
public class Frame3 extends Display {

//    public static final String DATA_FILE = "/socialnet.xml";
    public static final String DATA_FILE = "data/socialnet_quora.xml";
    ...
    public Frame3(Graph g, String label) {
    ...
    public static JPanel demo(Graph g, final String label) {        
        ...
        final Frame3 gview = new Frame3(g, label);
