...
import base.Excel07UtilBase;

/**
 * 整列处理xlsx格式的Excel表格，使用方法同ExcelUtil
 * @author MJ
 * @description
 */
public class Excel07Util extends Excel07UtilBase {
	...
	public static void main(String[] args) {
		...
		String xlsFileName = "F:\\天网1万ACM论文\\process\\ACM.xlsx";
		int sheetID = 2;
		String ColumnName = "author";
		String desxlsFileName = "F:\\天网1万ACM论文\\process\\ACM1.xlsx";
		int dessheetID = 0;
		String desColumnName = "author";
	...
	public static Vector<Integer> readIntegerSetFromExcel(String xlsFileName,
		...
		Excel07Util eu = new Excel07Util();
