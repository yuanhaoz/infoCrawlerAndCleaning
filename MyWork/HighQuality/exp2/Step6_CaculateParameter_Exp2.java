...
public class Step6_CaculateParameter_Exp2 {

	private static String cataa = "02-CQA网站中问题答案质量评估";
	private static String rootPath = "F:\\"+cataa+"\\NewData_HighQuality\\txt2Tokenizer\\file6_dataCNN(tile)";
...
//			createExcel();// 处理单个主题的数据
	...
	public static void dealAll() throws Exception{
		String rootPath = "F:\\qualityExtraction\\file6_dataCNN(tile)";
		...
		for(int i = 0; i < words.size(); i++){
			...
			String txt = keyword + "_tag_100_100_random";
