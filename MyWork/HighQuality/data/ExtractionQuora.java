...
//							System.out.println("数据插入成功！");
	...
	public static void extract2Excel(String keyword, int pageLength) throws Exception {
		//建立保存目录
		String filepath = path + "\\" + keyword + ".xls";
...
//				sheet.addCell(new Label(19, number, "", wcf_center));
				sheet.addCell(new Label(9, number, subjectpagecrawlertime, wcf_center));
...
//					String authorpath = path + keyword + i + "_author_" + (m - number) + ".html";
...
//					sheet.addCell(new Label(9, m + 1, answer, wcf_center));
					sheet.addCell(new Label(6, m + 1, contentlength + "",wcf_center));
					sheet.addCell(new Label(7, m + 1, "1", wcf_center));
					sheet.addCell(new Label(8, m + 1, i + "", wcf_center));
					// 作者偶像、作者提问数、爬取时间
//					sheet.addCell(new Label(18, m + 1, following, wcf_center));
//					sheet.addCell(new Label(19, m + 1, questions, wcf_center));
					sheet.addCell(new Label(9, m + 1, subjectpagecrawlertime, wcf_center));
...
//		sheet.addCell(new Label(9, 0, "AnswerSum", wcf_title));
		sheet.addCell(new Label(6, 0, "Word", wcf_title));
		sheet.addCell(new Label(7, 0, "Exist(1)", wcf_title));
		sheet.addCell(new Label(8, 0, "Sequence", wcf_title));
...
//		sheet.addCell(new Label(19, 0, "AuthorQuestion", wcf_title));
		sheet.addCell(new Label(9, 0, "crawlerTime", wcf_title));
