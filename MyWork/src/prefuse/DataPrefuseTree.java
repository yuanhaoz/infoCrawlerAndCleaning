...
public class DataPrefuseTree extends Display {

//    public static final String DATA_FILE = "/socialnet.xml";
    public static final String DATA_FILE = "file/data/socialnet_quora.xml";
    ...
    public DataPrefuseTree(Graph g, String label) {
    ...
    public static JPanel demo(Graph g, final String label) {        
        ...
        final DataPrefuseTree gview = new DataPrefuseTree(g, label);
